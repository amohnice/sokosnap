      ...
      <div className="z-10 w-full max-w-[420px] px-6 space-y-6">
        <div className="flex flex-col items-center text-center space-y-3">
          ...
          <div className="space-y-1">
            <h1 className="text-3xl font-black text-white tracking-tight">Create your store</h1>
            <p className="text-white/60 font-medium">Join thousands of micro-merchants today</p>
          </div>
        </div>
