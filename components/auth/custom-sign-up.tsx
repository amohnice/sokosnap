...
const AFTER_SIGN_UP_URL = process.env.NEXT_PUBLIC_CLERK_AFTER_SIGN_UP_URL || "/onboarding";
...
export function CustomSignUp() {
  ...
  return (
    <div className="space-y-6">
      {/* 
          Mount point for Clerk CAPTCHA bot protection. 
          Must be present in the DOM during the entire flow 
          to avoid 'clerk-captcha element not found' errors.
      */}
